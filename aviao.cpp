...
// variaveis pra escolher o lugar
...
// variaveis da função calandario
...
void printCalendar(int year, int month){
  ...
  std::tm timeinfo = {};
  timeinfo.tm_year = year - 1900; // tm_year mes o numero de anos desde 1900
  timeinfo.tm_mon = month - 1;    // tm_mon mes base 0 (janeiro ï¿½ representado por 0)
  timeinfo.tm_mday = 1;
  std::mktime(&timeinfo);

  // Obter o numero de dias no mes atual
  daysInMonth;
  if (month == 2){
    // Verificar se mês um ano bissexto (fevereiro tem 29 dias em anos bissextos)
  ...
  // Imprimir o cabecalho do calendario
